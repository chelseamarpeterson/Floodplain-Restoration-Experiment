...
scc.df = read.csv("Social_Cost_Carbon/SCC_Estimates.csv")
...
est.df = read.csv("Social_Cost_Carbon/Treatment_Establishment_Costs.csv")
...
ecoC.df1.melt = melt(ecoC.df1, id.vars=c("trt"), variable.name="stat",value.name="stock")
